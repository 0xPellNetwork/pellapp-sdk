...
//
//	go build -X github.com/0xPellNetwork/pellapp-sdk/version.Name=gaia \
//	 -X github.com/0xPellNetwork/pellapp-sdk/version.AppName=gaiad \
//	 -X github.com/0xPellNetwork/pellapp-sdk/version.Version=1.0 \
//	 -X github.com/0xPellNetwork/pellapp-sdk/version.Commit=f0f7b7dab7e36c20b757cebce0e8f4fc5b95de60 \
//	 -X "github.com/0xPellNetwork/pellapp-sdk/version.BuildTags=linux darwin amd64"
package version
...
func getSDKVersion() string {
	...
	for _, dep := range deps.Deps {
		if dep.Path == "github.com/0xPellNetwork/pellapp-sdk" {
...
type Info struct {
	...
	PellAppSdkVersion string     `json:"pellapp_sdk_version" yaml:"pellapp_sdk_version"`
